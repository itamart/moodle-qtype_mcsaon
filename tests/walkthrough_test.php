 ...
 *
 * Note, there are already lots of tests of the mcsaon type in the behaviour
 * tests. (Search for test_question_maker::make_a_mcsaon.) This file only
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_mcsaon_walkthrough_test extends qbehaviour_walkthrough_test_base {
    public function test_deferredfeedback_feedback_mcsaon_single() {

        // Create a mcsaon, single question.
        $mc = test_question_maker::make_a_mcsaon_single_question();
    ...
    public function test_deferredfeedback_feedback_mcsaon_multi() {
        // Create a mcsaon, multi question.
        $mc = test_question_maker::make_a_mcsaon_multi_question();
        $mc->shuffleanswers = false;
